...
class Detail_Notice extends CI_Controller {
  ...
  public function arbitration_notice(){
    ...
    public function AccidentalNotice(){
    ...
    public function pfNoticeDetail(){
        ...
        $data = $this->Detail_Notice_model->pfNoticeDetail($id);
    ...
    public function esiClaimList(){
       ...
       $this->load->library('session');
        ...
        $data = $this->Detail_Notice_model->esiClaimList($id);
    ...
    public function sexual_harrashment(){
   ...
   public function delay_in_constuction(){
   ...
   public function misconduct_list(){
        ...
        $data = $this->Detail_Notice_model->misconduct_list($id);
