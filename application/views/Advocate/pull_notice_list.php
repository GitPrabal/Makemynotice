<?php   echo  "<pre>";print_r($pull_notice_list);die; ?>
<div class="wrapper">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php for($i=0;$i<count($pull_notice_list);$i++){ ?>
                 <tr>
                  <td><?php echo $pull_notice_list[$i]->consumer_name." ".$pull_notice_list[$i]->consumer_lname ?></td>
                  <td><?php echo $pull_notice_list[$i]->consumer_email  ?></td>
                  <td><?php echo $pull_notice_list[$i]->consumer_phone ?></td>
                  <td><?php echo $pull_notice_list[$i]->added_date ?></td>
                  <td><button class="btn btn-info consumerNoticeDetails" id="<?php echo $pull_notice_list[$i]->consumer_last_id ?>">View Details</button>
