...
<div class="login-box" style="margin: 4% auto;">
  <div class="login-logo">
    ...
    <img src="../../../public/assets/img/logo.png" height="110" width="110" class="header_logo_image"></a>
</center>
    <a href="#"><b>Admin</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <div class="loader" style="display: none;"><center><i class="fa fa-spinner fa-pulse fa-3x fa-fw"></i></center><br /></div>
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat" id="adminLogin">Sign In</button>
        </div>
        <!-- /.col -->
      </div>
