  <main id="main">
    <section id="services" class="services section-bg mt-5">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300"></div>
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue width100 cursonPointer basic_details" data-table-name="consumer_notice" >
              <div class="icon">
                <img src="../public/assets/icons/Consumer-Notice.png" style="width: 40px;height: 40px;">
              </div>
              <h4>Consumer Notice</h4>
            </div>
          </div>

          <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-orange width100 cursonPointer basic_details" data-table-name="product_service">
              <div class="icon">  
                <img src="../public/assets/icons/Product-Service.png" style="width: 40px;height: 40px;">
              </div>
