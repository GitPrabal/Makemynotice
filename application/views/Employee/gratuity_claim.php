  ...
  <main id="main">
    ...
    <div class="container">
         ...
         <div class="row">
          ...
          <table style="border:0px;" class="table">
                  ...
                  <tr id="tr_employment_letter" class="no-border">
                   ...
                   <tr id="tr_employment_letter" class="no-border">
                     <td class="fontBold fontRoboto"> <b> Relieving Letter</b> </td>
                     <td> <div class="upload-btn">
                           <input type="file" id="relieving_letter" name="relieving_letter" onchange="checkFile(this.id,'tr_employment_letter')">
                        </div>
                     </td>
                  </tr>
                   <tr id="tr_communication_attachment" class="no-border">
                     <td class="fontBold fontRoboto"> <b> Prior Communication to or from the company</b> </td>
                     <td> <div class="upload-btn">
                           <input type="file" id="communication_attachment" name="communication_attachment" onchange="checkFile(this.id,'tr_communication_attachment')">
                        </div>
                     </td>
                  </tr>
               </tbody></table>
          ...
          <div class="col-lg-6">
              <div class="form-row">
                <div class="col-md-12 form-group">
                 <label>Gratuity Calculation<sup class="red">*</sup></label>
                     <textarea class="form-control" rows="8" id="gratuity_calculation" name="gratuity_calculation"></textarea>
        ...
        <div class="row mt-5">
          ...
          <div class="row mt-5">
          <div class="col-lg-6">
          <input type="hidden" name="data-table" value="gratuity_claim">
