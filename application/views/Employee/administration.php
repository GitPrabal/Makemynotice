 ...
 <style type="text/css">
  ...
  <main id="main">
    ...
    <div class="container">
        ...
        <div class="row mt-5">
          <div class="col-lg-6">
              <label>Name Of Department<sup class="red">*</sup></label>
              <input name="department_name" type="text" placeholder="Name Of Department"  class="form-control" id="department_name" >
              <span id="err_department_name" style="color:red;font-weight: bolder;display: none">This Field is required</span>
          </div>

          <div class="col-lg-6">
            <label>Address Of Department<sup class="red">*</sup></label>
            <input name="address_department" type="text" placeholder="Address Of Department"  class="form-control" id="address_department" >
         ...
         <div class="row">
          ...
          <table style="border:0px;" class="table">
                  <tbody><tr id="tr_communication" class="no-border">
                     <td class="fontBold fontRoboto"> <b>Any Communication to or from the said department</b> </td>
        ...
        <div class="row mt-5">
          ...
          <div class="row mt-5">
          <div class="col-lg-6">
          <input type="hidden" name="data-table" value="administration">
