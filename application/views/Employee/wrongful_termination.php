    ...
    <div class="container">
         ...
         <div class="row">
          ...
          <table style="border:0px;" class="table">
                  <tbody><tr id="tr_employment_letter" class="no-border">
                     <td class="fontBold fontRoboto"> <b> Employment Contract</b> </td>
                     <td> <div class="upload-btn">
                           <input type="file" id="employment_letter" name="employment_letter" onchange="checkFile(this.id,'tr_aggrement_employment')">
                        </div>
                     </td>
                  </tr>
               </tbody></table>
        ...
        <div class="row mt-5">
          <div class="col-lg-6">
              <div class="form-row">
                <div class="col-md-12 form-group">
                 <label>Grounds Of Temination provided by the company<sup class="red">*</sup></label>
                     <textarea class="form-control" rows="8" id="ground_termination" name="ground_termination"></textarea>
        ...
        <div class="row mt-5">
          ...
          <div class="row mt-5">
          <div class="col-lg-6">
           <input type="hidden" name="data-table" value="wrongful_termination">
