 ...
 <style type="text/css">
  ...
  <main id="main">
    ...
    <div class="container">
        <div class="row mt-5">
          <div class="col-lg-6">
             <label>Name Of Book and Branch<sup class="red">*</sup></label>
             <input name="branch_name" type="text" placeholder="Name"  class="form-control" id="branch_name" >
          </div>
         ...
         <div class="row">
          ...
          <table style="border:0px;" class="table">
                  <tbody>
                  <tr id="tr_sarfaesi_notice" class="no-border">
                     <td class="fontBold fontRoboto"> <b> Copy of the sar faesi notice</b> </td>
                     <td> <div class="upload-btn">
                           <input type="file" id="sarfaesi_notice" name="sarfaesi_notice" onchange="checkFile(this.id,'tr_sarfaesi_notice')">
                        </div>
                     </td>
                  </tr>
                  <tr id="tr_reply_notices" class="no-border">
                     <td class="fontBold fontRoboto"> <b> Reply Provided Earlier for all loan notices</b> </td>
                     <td> <div class="upload-btn">
                           <input type="file" id="reply_notices" name="reply_notices" onchange="checkFile(this.id,'tr_reply_notices')">
                        </div>
                     </td>
                  </tr>
               </tbody></table>
        ...
        <div class="row mt-5">
          <div class="col-lg-6">
              <div class="form-row">
                <div class="col-md-12 form-group">
                 <label>Grounds of Contention ?<sup class="red">*</sup></label>
                     <textarea class="form-control" rows="8" id="contention" name="contention"></textarea>
        ...
        <div class="row mt-5">
          ...
          <div class="row mt-5">
          <div class="col-lg-6">
          <input type="hidden" name="data-table" value="sarfaesi_notice">
