 ...
 <style type="text/css">
  ...
  <main id="main">
    ...
    <div class="container">
        ...
        <div class="row mt-5">
          <div class="col-lg-6">
             <label>Name Of Company / Employer <sup class="red">*</sup></label>
        ...
        <div class="row mt-2">
          <div class="col-lg-6">
             <label id = "label-motor-father-name" >Date Of Start Of Employment<sup class="red">*</sup></label>
             <input type="text" placeholder="ex 20/12/2020" name="date_emp" id="date_emp" class=" datepicker form-control" />
