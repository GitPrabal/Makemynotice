 ...
 <style type="text/css">
  ...
  <main id="main">
    ...
    <div class="container">
        <div class="row mt-5">
          <div class="col-lg-6">
              <label>Name Of Firm / Company<sup class="red">*</sup></label>
              <input name="company_name" type="text" placeholder="Name Of Company"  class="form-control" id="company_name" >
          </div>

          <div class="col-lg-6">
            <label>Address Of Company<sup class="red">*</sup></label>
        ...
        <div class="row mt-3">
          <div class="col-lg-6">
             <label id = "label-motor-father-name" >Date Of Employment<sup class="red">*</sup></label>
             <input type="text" placeholder="Date Of Employment" name="date_employment" id="date_employment" class="datepicker form-control" />
          </div>
        </div>
         ...
         <div class="row">
          ...
          <table style="border:0px;" class="table">
                  ...
                  <tr id="tr_employment_letter" class="no-border">
                     <td class="fontBold fontRoboto"> <b>Proof Of Employment At The Firm</b> </td>
                  ...
                  <tr id="tr_bank_statement" class="no-border">
                     <td class="fontBold fontRoboto"> <b>Bank Statement For Prior Paid Salaries</b> </td>
                     <td> <div class="upload-btn">
                           <input type="file" id="bank_statement" name="bank_statement" onchange="checkFile(this.id,'tr_bank_statement')">
                        </div>
                     </td>
                  </tr>
                  <tr id="tr_communication" class="no-border">
                     <td class="fontBold fontRoboto"> <b>Communication to and from the company regarding the payment of salary</b> </td>
                     <td> <div class="upload-btn">
        ...
        <div class="row mt-3">
          <div class="col-lg-6">
              <div class="form-row">
                <div class="col-md-12 form-group">
                 <label>Any Information To Be Provided<sup class="red">*</sup></label>
                  <input name="information" type="text" placeholder="Any Information"  class="form-control" id="information" >
                </div>
                </div>
              </div>
          </div>
        ...
        <div class="row mt-5">
         ...
         <div class="row mt-5">
          <div class="col-lg-6">
              <div class="form-row">
                <div class="col-md-12 form-group">
                <input type="hidden" name="data-table" value="non_payment_salary">
