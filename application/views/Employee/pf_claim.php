 ...
 <style type="text/css">
  ...
  <main id="main">
    ...
    <form method="post" id="notice-data" name="notice-data" enctype="multipart/form-data" method="post">
    <div class="container">
        <div class="row mt-5">
          <div class="col-lg-6">
             <label>Local PF Office Details <sup class="red">*</sup></label>
             <input type="text"   class="form-control" id="pf_office" name="pf_office" >
          </div>

          <div class="col-lg-6">
             <label>Address Of Local PF Office <sup class="red">*</sup></label>
             <input type="text"   class="form-control" id="pf_office_address" name="pf_office_address" >
          </div>
        </div>

        <div class="row mt-2">
          <div class="col-lg-6">
             <label>PF No. Complaint <sup class="red">*</sup></label>
             <input type="text" class="form-control" id="no_pf_complaint" name="no_pf_complaint" >
          </div>
        </div>
         ...
         <div class="row">
          ...
          <table style="border:0px;" class="table">
                  <tbody><tr id="tr_pf_complaint_attachment" class="no-border">
                     <td class="fontBold fontRoboto"> <b> Copy Of The PF complaint registered</b> </td>
                     <td> <div class="upload-btn">
                           <input type="file" id="pf_complaint_attachment" name="pf_complaint_attachment" onchange="checkFile(this.id,'tr_pf_complaint_attachment')">
                        </div>
                     </td>
                  </tr>
               </tbody></table>
