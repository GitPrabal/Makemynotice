  ...
  <main id="main">
    ...
    <div class="container">
        ...
        <div class="row mt-3">
         ...
         <div class="row">
          ...
          <table style="border:0px;" class="table">
                  <tbody><tr id="tr_aggrement_employment" class="no-border">
                     <td class="fontBold fontRoboto"> <b> Aggrement Of Employment</b> </td>
                     <td> <div class="upload-btn">
                           <input type="file" id="aggrement_employment" name="aggrement_employment" onchange="checkFile(this.id,'tr_aggrement_employment')">
                        </div>
                     </td>
                  </tr>
               </tbody></table>
        ...
        <div class="row mt-5">
          ...
          <div class="row mt-5">
          <div class="col-lg-6">
          <input type="hidden" name="data-table" value="voilation_aggrement">
