    ...
    <div class="container">
        ...
        <div class="row mt-5">
          <div class="col-lg-6">
              <div class="form-row">
                <div class="col-md-12 form-group">
                 <label>Retrenchment Reason<sup class="red">*</sup></label>
                     <textarea class="form-control" rows="8" id="retrenchment_reason" name="retrenchment_reason"></textarea>
        ...
        <div class="row mt-5">
          <div class="col-lg-6">
              <div class="form-row">
                <div class="col-md-12 form-group">
                 <label>Compensation Provide Calculation<sup class="red">*</sup></label>
                     <textarea class="form-control" rows="8" id="compensation_calculation" name="compensation_calculation"></textarea>
                     <span id="err_retrenchment_reason" style="color:red;font-weight: bolder;display: none">This Field is required</span>
                  <div class="validate"></div>
                </div>
              </div>
              ...
              <div class="form-row">
                <div class="col-md-12 form-group">
                 <label id = "label-motor-father-name" >Item handed over during termination ?<sup class="red">*</sup></label>
                     <textarea class="form-control" rows="8" id="item_handed" name="item_handed"></textarea>
                     <span id="err_reprimondent" style="color:red;font-weight: bolder;display: none">This Field is required</span>
                  <div class="validate"></div>
                </div>
              </div>
          </div>
