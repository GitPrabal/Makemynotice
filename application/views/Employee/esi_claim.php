 ...
 <style type="text/css">
  ...
  <main id="main">
    ...
    <div class="container">
        <div class="row mt-5">
          <div class="col-lg-6">
             <label>Local ESI Office<sup class="red">*</sup></label>
             <input type="text"   class="form-control" id="esi_office" name="esi_office" >
          </div>

          <div class="col-lg-6">
             <label>Address Of Local ESI Office <sup class="red">*</sup></label>
             <input type="text"   class="form-control" id="esi_office_address" name="esi_office_address" >
          </div>
        </div>

        <div class="row mt-2">
          <div class="col-lg-6">
             <label>Type Of ESI Complaint <sup class="red">*</sup></label>
             <input type="text" class="form-control" id="type_esi_complaint" name="type_esi_complaint" >
          </div>
        </div>
         ...
         <div class="row">
          ...
          <table style="border:0px;" class="table">
                  <tbody><tr id="tr_communication_esi" class="no-border">
                     <td class="fontBold fontRoboto"> <b> Any Communication with ESI Office</b> </td>
                     <td> <div class="upload-btn">
                           <input type="file" id="communication_esi" name="communication_esi" onchange="checkFile(this.id,'tr_communication_esi')">
                        </div>
                     </td>
                  </tr>
               </tbody></table>
