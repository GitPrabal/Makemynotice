 ...
 <style type="text/css">
  ...
  <main id="main">
    ...
    <div class="container">
        ...
        <div class="row mt-5">
          <div class="col-lg-6">
              <label>Name Of Bank / Branch<sup class="red">*</sup></label>
              <input name="bank_name" type="text" placeholder="Name Of bank"  class="form-control" id="bank_name" >
              <span id="err_company_name" style="color:red;font-weight: bolder;display: none">This Field is required</span>
          </div>

          <div class="col-lg-6">
            <label>Address Of Bank<sup class="red">*</sup></label>
            <input name="address_bank" type="text" placeholder="Address Of Bank"  class="form-control" id="address_bank" >
         ...
         <div class="row">
          ...
          <table style="border:0px;" class="table">
                  <tbody><tr id="tr_loan_notice" class="no-border">
                     <td class="fontBold fontRoboto"> <b>Copy Of The Loan Notice</b> </td>
                     <td> <div class="upload-btn">
                           <input type="file" id="loan_notice" name="loan_notice" onchange="checkFile(this.id,'tr_loan_notice')">
                        </div>
                     </td>
                  </tr>
               </tbody></table>
         ...
         <div class="row mt-3">
          <div class="col-lg-6">
              <div class="form-row">
                <div class="col-md-12 form-group">
                   <label id = "label-motor-father-name" >How Do You Want To Proceed<sup class="red">*</sup></label>
                     <textarea class="form-control disableAudio" rows="8" id="contand_notice" placeholder="Contand The Notice" name="contand_notice"></textarea>
          ...
          <div class="col-lg-6">
              <div class="form-row">
                <div class="col-md-12 form-group" style="text-align:center">
                   <label id = "label-motor-father-name" >OR</label>
                </div>
              </div>
          </div>
        </div>
        ...
        <div class="row mt-3">
          <div class="col-lg-6">
              <div class="form-row">
                <div class="col-md-12 form-group">
                     <textarea name="repayment_time" class="form-control disableAudio" rows="8" id="repayment_time" placeholder="Ask For Repayent (How Much Time)" name="contand_notice"></textarea>
                     <span id="err_rent" style="color:red;font-weight: bolder;display: none">This Field is required</span>
        ...
        <div class="row mt-5">
          ...
          <div class="row mt-5">
          <div class="col-lg-6">
           <input type="hidden" name="data-table" value="reply_to_bank">
