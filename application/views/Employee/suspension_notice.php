    ...
    <div class="container">
        ...
        <div class="row mt-5">
         ...
         <div class="row">
           ...
           <div class="row mt-5">
               <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">  
                  <div class="form-group">
                     <label>Duration Of Suspension<sup class="red">*</sup></label>
                     <input name="suspension_duration" type="text" placeholder="Duration Of Suspension"  class="form-control" id="suspension_duration" >
          ...
          <div class="col-lg-6">
              <div class="form-row">
                <div class="col-md-12 form-group">
                 <label>Reason For Suspension ?<sup class="red">*</sup></label>
                     <textarea class="form-control" rows="8" id="suspension_reason" name="suspension_reason"></textarea>
        ...
        <div class="row mt-5">
          <div class="col-lg-6">
              <div class="form-row">
                <div class="col-md-12 form-group">
                 <label>Reprimondent or Warning To Be Given ?<sup class="red">*</sup></label>
                     <textarea class="form-control" rows="8" id="reprimondent" name="reprimondent"></textarea>
                  <div class="validate"></div>
                </div>
              </div>
          </div>
        ...
        <div class="row mt-5">
          ...
          <div class="row mt-5">
          <div class="col-lg-6">
          <input type="hidden" name="data-table" value="suspension_notice">
