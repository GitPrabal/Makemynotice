 ...
 <style type="text/css">
  ...
  <main id="main">
    ...
    <div class="container">
        ...
        <div class="row mt-5">
          <div class="col-lg-6">
               <label>Name Of Defendant Or Company <sup class="red">*</sup></label>
          ...
          <div class="col-lg-6">
            <label id = "label-motor-father-name" >Address Of Defendant<sup class="red">*</sup></label>
            <input type="text" placeholder="K Street Palli Hill ,  Mumbai , Maharastra" name="address_defendant" id="address_defendant" class="form-control" />
          ...
          <div class="row mt-3">
          <div class="col-lg-6">
               <label>Details Of the Construction Project With Address <sup class="red">*</sup></label>
               <input name="details_project" type="text" placeholder="Details Of The Construction Project"  class="form-control" id="details_project" >
              <span id="err_company_name" style="color:red;font-weight: bolder;display: none">This Field is required</span>
          </div>
        </div>
         ...
         <div class="row">
          ...
          <table style="border:0px;" class="table">
                  <tbody><tr id="tr_agreement_attachment" class="no-border">
                     <td class="fontBold fontRoboto"> <b>Construction Agreement</b> </td>
