    ...
    <div class="container">
        ...
        <div class="row mt-5">
          <div class="col-lg-6">
              <div class="form-row">
                <div class="col-md-12 form-group">
                 <label>Person Exercising the  abuse of power<sup class="red">*</sup></label>
                     <input name="person_excersing" type="text" placeholder="Person Exercising the  Abuse of Power"  class="form-control" id="person_excersing" ></div>
                </div>
              </div>
          </div>
        ...
        <div class="row mt-5">
          <div class="col-lg-6">
              <div class="form-row">
                <div class="col-md-12 form-group">
                <input type="hidden" name="data-table" value="abuse_power">
