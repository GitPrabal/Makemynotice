  ...
  <main id="main">
    ...
    <div class="container">
        ...
        <div class="row mt-5">
          ...
          <div class="row mt-4">
          <div class="col-lg-6">
               <label>Nature Of Trespassing<sup class="red">*</sup></label>
               <input name="nature_trespassing" type="text" placeholder="Nature Of Trespassing"  class="form-control" id="nature_trespassing" >
              <span id="err_company_name" style="color:red;font-weight: bolder;display: none">This Field is required</span>
          </div>
           <div class="col-lg-6">
                <label>Property Of Which Trespassing Occured<sup class="red">*</sup></label>
                <input name="trespassing_occured" type="text" placeholder="Nature Of Trespassing"  class="form-control" id="trespassing_occured" >
              <span id="err_company_name" style="color:red;font-weight: bolder;display: none">This Field is required</span>
          </div>
        </div>
         ...
         <div class="row">
          ...
          <table style="border:0px;" class="table">
                  <tbody><tr id="tr_title_deed" class="no-border">
                     <td class="fontBold fontRoboto"> <b>Title Deed Of the property paper to prove ownership</b> </td>
        ...
        <div class="row mt-5">
          <div class="col-lg-6">
              <div class="form-row">
                <div class="col-md-12 form-group">
                 <label>Details Of The Trespassing ?<sup class="red">*</sup></label>
                     <textarea class="form-control" rows="8" id="detail_trespassing" name="detail_trespassing"></textarea>
        ...
        <div class="row mt-5">
          ...
          <div class="row mt-5">
          <div class="col-lg-6">
          <input type="hidden" name="data-table" value="trespassing">
