 ...
 <style type="text/css">
  ...
  <main id="main">
    ...
    <div class="container">
        <div class="row mt-5">
          <div class="col-lg-6">
              <label>Name Of Spouse<sup class="red">*</sup></label>
              <input name="name_spouse" type="text" placeholder="Name Of Department"  class="form-control" id="name_spouse" >
          </div>

          <div class="col-lg-6">
            <label>Address Of Spouse<sup class="red">*</sup></label>
            <input name="address_spouse" type="text" placeholder="Address Of Department"  class="form-control" id="address_spouse" >
          </div>
        </div>
         ...
         <div class="row">
          ...
          <table style="border:0px;" class="table">
                  <tbody><tr id="tr_marriage" class="no-border">
                     <td class="fontBold fontRoboto"> <b>Marriage Certificate or Proof Of Marriage</b> </td>
                     <td> <div class="upload-btn">
                           <input type="file" id="marriage" name="marriage" onchange="checkFile(this.id,'tr_marriage')">
                        </div>
                     </td>
                  </tr>
               </tbody></table>
        ...
        <div class="row mt-5">
          <div class="col-lg-6">
              <div class="form-row">
                <div class="col-md-12 form-group">
                  <label id = "label-motor-father-name" >Reason for Divorce ?<sup class="red">*</sup></label>
                     <textarea class="form-control" rows="8" id="reason_divorce" name="reason_divorce"></textarea>
        ...
        <div class="row mt-5">
          <div class="col-lg-6">
              <div class="form-row">
                <div class="col-md-12 form-group">
                 <label id = "label-motor-father-name" >Claim In Divorce ?<sup class="red">*</sup></label>
                     <textarea class="form-control" rows="8" id="claim_divorce" name="claim_divorce"></textarea>
                  <div class="validate"></div>
                </div>
              </div>
          </div>
        ...
        <div class="row mt-5">
          ...
          <div class="row mt-5">
          <div class="col-lg-6">
           <input type="hidden" name="model" value="Family_Disputes" id="model">
           <input type="hidden" name="function" id="function" value="divorceFinalSubmit">
